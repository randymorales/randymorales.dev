...
export const PROJECTS_DATA = [
  {
    ...
    title: 'PennyWise',
    description:
      'A personal-finance PWA for Costa Rica with multi-currency (CRC/USD) budgets. Built with Next.js, Supabase, and Tailwind CSS.',
  ...
  },
  {
    ...
    description:
      'A native macOS menu-bar tray for the GitHub PRs and issues assigned to you. Read-only by design. Built with a Rust CLI and a SwiftUI shell.',

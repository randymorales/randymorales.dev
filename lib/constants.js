...
export const PROJECTS_DATA = [
  {
    id: '1',
    title: 'PennyWise',
    description: 'A personal-finance PWA for Costa Rica with multi-currency (CRC/USD) budgets, a per-category traffic-light semáforo, transaction splits, recurring entries, debts, and savings goals. Built with Next.js, Supabase, and Tailwind CSS.',
